...
const NavBar = ({
  ...
  let color = colour ? colour : "#fafffe";
  let back = bg ? bg : " ";
  return (
    <div className={`navbar ${displayNav ? "showNav" : "dontShowNav"}`} style={{ backgroundColor: `${back}` }}>
      <div className="container" style={{ backgroundColor: `${back}` }}>
        <div onClick={() => navigate("home")} className="logo">
          ...
          >
            ...
            />
            <path
              d="M238.373 124.684V103.904L155.253 52.7531L68.1362 103.904V124.684"
              stroke={color}
              stroke-width="7"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M280.732 161.449C293.091 161.449 303.111 151.429 303.111 139.07C303.111 126.711 293.091 116.692 280.732 116.692C268.373 116.692 258.354 126.711 258.354 139.07C258.354 151.429 268.373 161.449 280.732 161.449Z"
              fill={color}
            />
            <path
              d="M23.3789 107.101V79.128L153.654 4L278.334 79.128V126.283"
              stroke={color}
              stroke-width="7"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M23.3774 139.071C11.0181 139.071 0.998859 149.09 0.998859 161.449C0.998859 173.808 11.0181 183.828 23.3774 183.828C35.7367 183.828 45.7559 173.808 45.7559 161.449C45.7559 149.09 35.7367 139.071 23.3774 139.071Z"
              fill={color}
            />
            <path
              d="M280.73 193.418V221.391L150.455 296.519L25.7749 221.391V174.236"
              stroke={color}
              stroke-width="7"
              stroke-linecap="round"
              stroke-linejoin="round"
          ...
          <div className="navloading">
            <h1 style={{ color: `${color}` }}>ebbon.</h1>
          </div>
        </div>
        { clickedRoute === "services" ?
        ...
        <div className="nav_toggler_container">
          <div
            ...
            className={mobileNavopen ? "nav_toggler open tint" : "nav_toggler tint"}
          >
            <span></span>
          </div>
        </div>
            ...
            <div className="nav_items_list_container">
              <ul className="nav_item_list">
                <li
                  ...
                  className={clickedRoute === "work" ? "active" : "notactive"}
                  style={{ color: `${color}` }}
                >
                  Work
                </li>
                <li
                  ...
                  className={
                    clickedRoute === "services" ? "active" : "notactive"
                  }
                  style={{ color: `${color}` }}
                >
                  Services
                ...
                <li
                  ...
                  className={clickedRoute === "about" ? "active" : "notactive"}
                  style={{ color: `${color}` }}
                >
                  About us
                </li>
