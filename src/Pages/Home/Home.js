          ...
          <div className="section_container fdcolumn">
            <div className="contents home_first">
              <h1 className="slogan_h1 colorchange">
                High-end digital products for Enterprenuers and fast growing
                Startups.
              </h1>
              <p className="what_we_do_p">
                We build dynamic, scalable and unique digital products with
              ...
              <div className="flex hfc home_third_container">
                <div className="ourapproach">
                  <div className="ourapproach_text">
                    <p>
                      Crafting thoutghful and simple digital product solutions,
                      through, research, and strategic planning to help users
                      and business ownwers achieve their business goals.
                    </p>
                  </div>
          ...
          <div className="section_container">
            <div className="contents home_fourth">
              <div className="flex hfc fdcolumn">
                <h1>
                  Featured<br></br>Works
                </h1>

                <div
                  className="flex fdrow featured_works_container"
                  style={{ margin: "10px 0px" }}
                >
                  <div className="featured_works_box">
                    <div
                      className="featured_works_box_image"
                      style={{ backgroundColor: "#216250" }}
                    >
                      <h2>HiveHotels</h2>
                    </div>
                    <h4 className="featured_works_box_text">
                      HiveHotels - Hotel management apps with customize websites
                      for hotels.
                    </h4>
                  </div>
                  ...
                  <div className="featured_works_box fwbl">
                    <div
                      className="featured_works_box_image"
                      style={{ backgroundColor: "#883E26" }}
                    >
                      <h2>Utilon</h2>
                    </div>
                    <h4 className="featured_works_box_text">
                      Utilon - The all-in-one utility app for anything and all
                      things.
                    </h4>
                  </div>
                </div>
                ...
                >
                  <div className="featured_works_box">
                    <div
                      className="featured_works_box_image"
                      style={{ backgroundColor: "#2D4E59" }}
                    >
                      <h2>Roomy</h2>
                    </div>
                    <h4 className="featured_works_box_text">
                      Roomy - A web application for clients to find houses and.
                    </h4>
                  </div>
        ...
        <div className="section pebground" style={{ height: "fit-content" }}>
          <div className="section_container">
            <div className="contents home_fifth">
              <h1>
                Building high-end digital products that are impossible to
                ignore.
              </h1>
                ...
                <div className="building">
                  <div className="building_text_container">
                    <div className="building_text">
                      <p>
                        African’s best leading digital agency with solid
                        experties and experience in branding, design and
                        development.
                      </p>
                    </div>
            ...
            <div className="contents home_sixth">
              ...
              <div className="flex fdcolumn hfc jcsevenly">
                ...
                <div className="flex rights_and_privacy">
                  <p>
                    © Rebbon Tech 2022. All rights reserved.{" "}
                    <p>Privacy policy</p>
                  </p>
                </div>
              </div>
