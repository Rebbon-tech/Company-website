  ...
  return (
    <div className="about">
        ...
        <div className="about_section mnbground about-uppersection">
          <div className="about_section_container h100p fdcolumn">
            <div className="content about_first">
              <h1 className="Title">We are<br></br>Rebbon Tech. </h1>
            </div>
          </div>
          <div className="glow">
            <svg width="1187" height="1035" viewBox="0 0 1187 1035" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="about_section twbground origin-container">
          <div className="about_section_container h100p fdcolumn origin">
            <div className="content about_second">
              <h1>OUR ORIGIN STORY</h1>
              <div className="origin_p_scroll">
                <p>
                Our business was created to meet the need for simple, affordable, fast and secure managed services. <br></br><br></br>
                The Tech Company, formally SSH Consulting, was launch in 2021 because our founder, Oluyoh Okiemute, was tired of watching companies, IT Managers and business owners struggle with ineffective and dated IT solutions, exorbitant prices and constant downtime.<br></br><br></br>

                Today, we have become an industry trail blazing company specializing in hosted Infrastructure environments, outsourced technology solutions management and technology risk assessment. Our goal is to fulfil the increasing need for outsourced advisory & consulting services in Southern Africa and abroad.<br></br><br></br>

                Our passion for providing the best quality end-to-end solutions from strategy to deployment and beyond has sustained the Tech Company’s sustainable growth since our founding. With a consistent retention rate and an uptime percentage that is as near perfect as you can get we believe our work speaks on our behalf.<br></br><br></br>

                Our enterprise services span several corporate sectors and vertical markets, but we have achieved great success providing solutions in the Retail & Financial sectors specifically. Over time we have also invested and formed product relationships with large-scale software and product houses which enables us to translate value to our clients and provide best in market solutions.<br></br><br></br>

                We have seen substantial growth in the past years, but our focus remains on serving our customers and providing the best solutions possible to them
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="about_section cgbground drive-us-container">
          <div className="about_section_container h100p fdcolumn drive-us">
        ...
        <div className="section twbground other-container">
          <div className="about_section_container h100p fdcolumn other">
            <div className="content about_fifth">
              <h1>Optimized solutions with simple onboarding process to help us better understand and improve our client's needs.</h1>
            </div>
          </div>
        </div>
